    ...
    extend: {
      ...
      keyframes: {
        ...
        evolution: {
          ...
          "70%": { transform: "scale(1)", filter: "blur(3px) grayscale(100%)",},
          "80%": { transform: "scale(0.6)", filter: "blur(2px) grayscale(100%)" },
          "90%": { transform: "scale(0.3)", filter: "blur(2px) grayscale(100%)" },
          "100%": { transform: "scale(0.1)", filter: "blur(3px) grayscale(100%)" },
        },
      },
    },
  },
